...
use DevHau\Modules\Contracts\RepositoryInterface;
use DevHau\Modules\Exceptions\InvalidAssetPath;
use DevHau\Modules\Exceptions\ModuleNotFoundException;
//use DevHau\Modules\Process\Installer;
//use DevHau\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
    ...
    {
        return $this->config->get('devhau-module.' . $key, $default);
    }
     ...
     * @return string
     * @throws \DevHau\Modules\Exceptions\ModuleNotFoundException
     */
